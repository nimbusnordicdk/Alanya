							...
							<ul class="to-form-field-list">					
								...
								<li>
									...
									<span class="to-legend">
										...
										<?php esc_html_e('This option requires wooCommerce to be installed and set up. "WooCommerce support" option has to be disabled.','chauffeur-booking-system'); ?>
									</span>
									<div class="to-radio-button">
									...
									<ul class="to-form-field-list">
										...
										<li>
											...
											<div>
												...
												<div>
													<input type="text" maxlength="4" name="<?php CHBSHelper::getFormName('duration_distance_min'); ?>" value="<?php echo esc_attr($this->data['meta']['duration_distance_min']); ?>"/>
												</div>
												<div>
													<input type="text" maxlength="4" name="<?php CHBSHelper::getFormName('duration_distance_max'); ?>" value="<?php echo esc_attr($this->data['meta']['duration_distance_max']); ?>"/>
												</div>
											</div>						  
											<div>
												<span class="to-legend-field"><?php esc_html_e('Step (integer value from 1 to 9999):','chauffeur-booking-system'); ?></span>
												<div>
													<input type="text" maxlength="4" name="<?php CHBSHelper::getFormName('duration_distance_step'); ?>" value="<?php echo esc_attr($this->data['meta']['duration_distance_step']); ?>"/>
												</div>
											</div>	
											<div>
												...
												<div>
													<input type="text" name="<?php CHBSHelper::getFormName('duration_distance_list'); ?>" value="<?php echo esc_attr($this->data['meta']['duration_distance_list']); ?>"/>
												</div>
											</div>	
										</li>										
										<li>
								...
								<div id="meta-box-booking-form-1-11-5">		
									<ul class="to-form-field-list">
										<li>
											...
											<span class="to-legend">
												<?php esc_html_e('Enable or disable fourth step named "Booking summary" in booking form.','chauffeur-booking-system'); ?>
											</span>
											<div class="to-radio-button">
...
?>
						...
						<li>
							<h5><?php esc_html_e('Style','chauffeur-booking-system'); ?></h5>
							<span class="to-legend">
								<?php esc_html_e('Enter (in JSON format) styles for map.','chauffeur-booking-system'); ?><br/>
								<?php echo sprintf(__('You can create your own styles using <a href="%s" target="_blank">Styling Wizard</a>.','chauffeur-booking-system'),'https://mapstyle.withgoogle.com/'); ?><br/>
							</span> 
							<div class="to-clear-fix">
								<textarea rows="1" cols="1" name="<?php CHBSHelper::getFormName('google_map_style'); ?>"><?php echo esc_html($this->data['meta']['google_map_style']); ?></textarea>
							</div>						  
						</li>						
					</ul> 
				</div>
