				...
				<div id="meta-box-price-rule-6">
					<ul class="to-form-field-list">
						<li>
							...
							<span class="to-legend">
								<?php echo __('This option determine, whether availability will be set up based on this rule only or plugin has to processing next rule based on order.','chauffeur-booking-system'); ?>
							</span>			   
							<div>
								<div class="to-radio-button">
