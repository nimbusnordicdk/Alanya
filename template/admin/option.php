				...
				<div class="to-header to-clear-fix">
					...
					<div class="to-header-right">
						...
						<div>
							...
							<a href="<?php echo esc_url('https://1.envato.market/chauffeur-booking-system-for-wordpress'); ?>" target="_blank"><?php esc_html_e('Plugin site','chauffeur-booking-system'); ?></a>&nbsp;&middot;
							<a href="<?php echo esc_url('https://codecanyon.net/user/quanticalabs/portfolio?term=Add-on+Chauffeur+Taxi+Booking+System'); ?>" target="_blank"><?php esc_html_e('Add-ons','chauffeur-booking-system'); ?></a>
						</div>
				...
				<div class="to-content to-clear-fix">
					...
					<div class="to-content-left">
						...
						<ul class="to-menu" id="to_menu">
							...
							<li>
								<a href="https://codecanyon.net/user/quanticalabs/portfolio?term=Add-on+Chauffeur+Taxi+Booking+System" target="_blank"><?php esc_html_e('Add-ons','chauffeur-booking-system'); ?><span></span></a>
							</li>
						</ul>
